...
public abstract class AbstractRaffleStrategy implements IRaffleStrategy {
    ...
    public RaffleAwardEntity performRaffle(RaffleFactorEntity raffleFactorEntity) {
        ...
        RuleActionEntity<RuleActionEntity.RaffleBeforeEntity> ruleActionBeforeEntity =
                this.doCheckRaffleBeforeLogic(RaffleFactorEntity.builder().userId(userId)
...
//    protected abstract RuleActionEntity<RuleActionEntity.RaffleCenterEntity> doCheckRaffleAfterLogic(RaffleFactorEntity raffleFactorEntity, String... logics);
}
