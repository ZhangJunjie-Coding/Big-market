package com.zhang.domain.rebate.service;
...
//                    .orderId(String.valueOf(iIdGenerator.nextId()))
            ...
            // 构建事件消息
            BaseEvent.EventMessage<SendRebateMessageEvent.RebateMessage>
                    rebateMessageEventMessage = sendRebateMessageEvent.buildEventMessage(rebateMessage);
