package com.zhang.domain.award.service.distribute.impl;
...
public class UserCreditRandomAward implements IDistributeAward {
    ...
    public void giveOutPrizes(DistributeAwardEntity distributeAwardEntity) {
        ...
        UserAwardRecordEntity userAwardRecordEntity = GiveOutPrizesAggregate
                .buildDistributeUserAwardRecordEntity(
        ...
        UserCreditAwardEntity userCreditAwardEntity = GiveOutPrizesAggregate
                .buildUserCreditAwardEntity(distributeAwardEntity.getUserId(),
                        creditAmount);
