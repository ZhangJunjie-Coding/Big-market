...
import com.zhang.domain.credit.model.entity.CreditOrderEntity;
import com.zhang.domain.credit.model.entity.TaskEntity;
import com.zhang.domain.credit.repository.ICreditRepository;
import com.zhang.infrastructure.event.EventPublisher;
import com.zhang.infrastructure.dao.ITaskDao;
import com.zhang.infrastructure.dao.IUserCreditAccountDao;
import com.zhang.infrastructure.dao.IUserCreditOrderDao;
import com.zhang.infrastructure.dao.po.Task;
import com.zhang.infrastructure.dao.po.UserCreditAccount;
import com.zhang.infrastructure.dao.po.UserCreditOrder;
...
public class CreditRepository implements ICreditRepository {
    ...
    public CreditAccountEntity queryUserCreditAccount(String userId) {
        ...
        try {
            ...
            return CreditAccountEntity.builder().userId(userId)
                    .adjustAmount(availableAmount).build();
        } finally {
            dbRouter.clear();
        }
