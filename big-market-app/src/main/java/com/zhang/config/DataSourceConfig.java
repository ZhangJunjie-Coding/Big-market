 ...
 * @Author: ZhangJunjie
 * @Description: TODO
 * @DateTime: 2026/7/6 15:24
 **/
@Configuration
public class DataSourceConfig {
    @Configuration
    @MapperScan(basePackages = "com.zhang.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "com.zhang.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
